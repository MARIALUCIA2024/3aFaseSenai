      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full border p-2 rounded-lg focus:ring-2 focus:ring-cyan-600 outline-none  hover:bg-gray-50 transition"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            value={formData.rg}
            onChange={handleInputChange}
            className="w-full border p-2 rounded-lg  hover:bg-gray-50 transition"
            required
          />
        </div>
