  ...
  return (
    <div className="bg-white shadow rounded-2xl p-6 mt-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-3">
        <label htmlFor="search" className="text-gray-700 font-mediu ">
          Buscar Paciente:
        </label>
        <input
          type="text"
          ...
          className="bg-emerald-200 border rounded-lg px-3 py-2 w-full sm:w-80 focus:ring-2 focus:ring-cyan-600 outline-none  hover:bg-gray-50 transition "
        />
      </div>
